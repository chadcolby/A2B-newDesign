...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.distanceLabel.font = [UIFont fontWithName:kPRIME_TEXT size:17.0f];
    cell.unitLabel.font = [UIFont fontWithName:kPRIME_TEXT size:17.0f];
    cell.instructionsLabel.font = [UIFont fontWithName:kPRIME_TEXT size:15.0f];
